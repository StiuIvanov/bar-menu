...
class HomeControllerTest {
    ...
    @Test
    void homeAnonymousShouldReturnIndex() throws Exception {
        mockMvc
                .perform(get("/"))
    ...
    void homeUserShouldReturnHome() throws Exception {
        mockMvc
                .perform(get("/"))
                .andExpect(status().isOk())
                .andExpect(view().name("home"))
                .andExpect(model().attributeExists("userPicture", "children"));
    }
